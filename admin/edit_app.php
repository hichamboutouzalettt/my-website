			...
			<div class="mr-admin-content-wrapper">				
				<div class="dashboard-wrapper">
					...
					<div class="dashboard-header-wrapper animated fadeInDown">
						...
						<h1 class="dashboard-header-title">Editing App: <img class="img-fluid edit-app-icon" src="../<?php echo htmlspecialchars($data['app_img_src']); ?>" alt="<?php echo htmlspecialchars($data['app_name']); ?>"><?php if (htmlspecialchars(isset($data['app_name']))) { echo htmlspecialchars($data['app_name']); } ?></h1>
								...
								<form action="db_action/e_a.php" method="POST" enctype="multipart/form-data">
									...
									<div class="dashboard-content-panel-content">
										...
										<div class="row">
											<div class="col-lg-5 mmfwot">
												<div class="form-group">
													...
													<input type="text" name="app_name" class="mr-input-style" placeholder="App Name..." required value="<?php if (htmlspecialchars(isset($data['app_name']))) { echo htmlspecialchars($data['app_name']); } ?>" />
											...
											<div class="col-lg-2 mmfwot">
												<div class="form-group">
													...
													<input type="text" name="app_short_name" class="mr-input-style" placeholder="Short Name..." required value="<?php if (htmlspecialchars(isset($data['app_short_name']))) { echo htmlspecialchars($data['app_short_name']); } ?>" />
										...
										<div class="form-group">
											...
											<textarea name="app_description" class="mr-textarea-style" placeholder="App Description..." required><?php if (htmlspecialchars(isset($data['app_description']))) { echo htmlspecialchars($data['app_description']); } ?></textarea>
										</div>
										<div class="row">
										...
										<div class="form-group">
											...
											<input type="text" name="app_locker_url" class="mr-input-style" placeholder="Redirect URL..." value="<?php if (htmlspecialchars(isset($data['app_locker_url']))) { echo htmlspecialchars($data['app_locker_url']); } ?>" required />
